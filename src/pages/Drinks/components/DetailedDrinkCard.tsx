    ...
    <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-8 rounded-lg max-w-md overflow-y-auto">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-8">
          <img src={drink.strDrinkThumb} alt="Picture of drink" className="w-full md:w-auto h-auto mb-4 md:mb-0" />
          <div>
            ...
            <div className="mb-2">Quantity: <QuantityInput value={quantity} onChange={handleQuantityChange} /></div>
          </div>
        </div>
        <div className="flex justify-center mt-4">
          <AddToCartButton article={{ ...drink, quantity }} />
          <button className="ml-4 px-4 py-2 text-white bg-gray-300 rounded hover:bg-gray-600" onClick={onClose}>Back</button>
        </div>
      </div>
    </div>
  );
