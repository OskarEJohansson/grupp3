      ...
      <div>
            ...
            <div className="w-full md:w-1/2 md:pr-2">
              <div className="bg-white p-6 md:p-8 rounded-lg shadow-md text-left text-gray-800 font-sans antialiased mb-8">
                ...
                <p className="text-base md:text-lg mb-6">
                  Embark on a journey of taste and flavor with our handcrafted
                  menu, meticulously curated by our culinary experts. From
                  savory bites to sweet delights, every dish is a masterpiece
                  waiting to be savored.
                </p>
                <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
                  <Link to="/recipe-page">
                    <button className="bg-yellow-500 text-white py-2 px-6 rounded-md shadow-md hover:bg-yellow-600 transition duration-300 ease-in-out">
                      Explore Food
                    </button>
                  </Link>
                  <Link to="/drink-page">
                    <button className="bg-[#fcdaab] text-white py-2 px-6 rounded-md shadow-md hover:bg-[#e3c499] transition duration-300 ease-in-out">
                      Explore Drinks
                    </button>
                  </Link>
                </div>
        ...
        <section className="bg-gray-100 py-8 px-4 text-center">
          ...
          <p className="text-base md:text-lg text-gray-700">
            Experience culinary perfection with our carefully crafted menu,
            curated by top chefs from around the world. Each dish is
            meticulously prepared using the finest ingredients to tantalize your
